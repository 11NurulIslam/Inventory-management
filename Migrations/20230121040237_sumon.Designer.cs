...
namespace InventoryBeginners.Migrations
{
    ...
    [Migration("20230121040237_sumon")]
    partial class sumon
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventoryBeginners.Models.Currency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InventoryBeginners.Models.PoDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InventoryBeginners.Models.PoHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InventoryBeginners.Models.Currency", b =>
                {
                    b.HasOne("InventoryBeginners.Models.Currency", "Currencies")
                        .WithMany()
            ...
            modelBuilder.Entity("InventoryBeginners.Models.PoDetail", b =>
                {
                    b.HasOne("InventoryBeginners.Models.PoHeader", "PoHeader")
                        .WithMany("PoDetails")
                        .HasForeignKey("PoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InventoryBeginners.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("InventoryBeginners.Models.PoHeader", b =>
                {
                    b.HasOne("InventoryBeginners.Models.Currency", "BaseCurrency")
                        .WithMany()
                        .HasForeignKey("BaseCurrencyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InventoryBeginners.Models.Currency", "POCurrency")
                        .WithMany()
                        .HasForeignKey("PoCurrencyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InventoryBeginners.Models.Supplier", "Supplier")
                        .WithMany()
